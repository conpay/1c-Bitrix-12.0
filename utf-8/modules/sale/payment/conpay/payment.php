...
// ¬ыбираем заказанные товары из базы данных
...
// «аполн€ем массив товаров и передаем его в модуль
...
while($item = $res->Fetch()) {
	if ($item) {
		...
		// ќпредел€ем URL страницы товара
		...
		// ƒобавл€ем свойства товара к массиву
