...
$aTabs = array(
	array(
		"DIV" => "basic_settings", "TAB" => GetMessage("CONPAY_BASIC_SETTINGS"), "TITLE" => GetMessage("CONPAY_BASIC_SETTINGS_TITLE"),
	),
	array(
		"DIV" => "advanced_settings", "TAB" => GetMessage("CONPAY_ADVANCED_SETTINGS"), "TITLE" => GetMessage("CONPAY_ADVANCED_SETTINGS_TITLE"),
	)
);
...
if ($REQUEST_METHOD == "POST"
	...
	if(strlen($RestoreDefaults) > 0) {
		...
		foreach ($set as $k => $v) COption::SetOptionString('conpay', $k, $v);
	}
